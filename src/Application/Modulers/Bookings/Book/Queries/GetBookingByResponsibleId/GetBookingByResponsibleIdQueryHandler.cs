...
internal sealed class GetBookingByResponsibleIdQueryHandler(IApplicationDbContext context)
    : IRequestHandler<GetBookingByResponsibleIdQuery, List<BookingDto>>
{
    public async Task<List<BookingDto>> Handle(GetBookingByResponsibleIdQuery request, CancellationToken cancellationToken)
    {
