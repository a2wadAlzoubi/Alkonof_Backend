...
internal sealed class GetBookingByUserIdStatusDateQueryHandler(IApplicationDbContext context)
    : IRequestHandler<GetBookingByUserIdStatusDateQuery, List<BookingDto>>
{
    public async Task<List<BookingDto>> Handle(GetBookingByUserIdStatusDateQuery request, CancellationToken cancellationToken)
    {
