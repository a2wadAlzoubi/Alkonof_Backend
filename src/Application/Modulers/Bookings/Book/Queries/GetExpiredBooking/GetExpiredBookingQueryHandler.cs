...
internal sealed class GetExpiredBookingQueryHandler(IApplicationDbContext context)
    : IRequestHandler<GetExpiredBookingQuery, List<BookingDto>>
{
    public async Task<List<BookingDto>> Handle(GetExpiredBookingQuery request, CancellationToken cancellationToken)
    {
