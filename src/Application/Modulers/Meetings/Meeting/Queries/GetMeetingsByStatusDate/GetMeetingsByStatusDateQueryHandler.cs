...
internal sealed class GetMeetingsByStatusDateQueryHandler(IApplicationDbContext context)
    : IRequestHandler<GetMeetingsByStatusDateQuery, List<MeetingDto>>
{
    public async Task<List<MeetingDto>> Handle(GetMeetingsByStatusDateQuery request, CancellationToken cancellationToken)
    {
