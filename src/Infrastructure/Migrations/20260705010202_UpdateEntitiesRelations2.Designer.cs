...
namespace Alkonof_Backend.Infrastructure.Migrations
{
    ...
    [Migration("20260705010202_UpdateEntitiesRelations2")]
    partial class UpdateEntitiesRelations2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Alkonof_Backend.Domain.Entities.Meeting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Alkonof_Backend.Domain.Entities.OrderBooking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Alkonof_Backend.Domain.Entities.PrepareMeeting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Alkonof_Backend.Domain.Entities.StageImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Alkonof_Backend.Domain.Entities.TaskTabel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Alkonof_Backend.Domain.Entities.Booking", b =>
                {
                    b.HasOne("Alkonof_Backend.Domain.Entities.Contract", "Contract")
                        .WithOne("Booking")
                        .HasForeignKey("Alkonof_Backend.Domain.Entities.Booking", "ContractId");

                    b.HasOne("Alkonof_Backend.Domain.Entities.User", "Customer")
                        .WithMany()
                    ...
                    b.HasOne("Alkonof_Backend.Domain.Entities.User", null)
            ...
            modelBuilder.Entity("Alkonof_Backend.Domain.Entities.Contract", b =>
                {
                    b.HasOne("Alkonof_Backend.Domain.Entities.Project", "Project")
                        .WithOne("Contract")
                        .HasForeignKey("Alkonof_Backend.Domain.Entities.Contract", "ProjectId");
            ...
            modelBuilder.Entity("Alkonof_Backend.Domain.Entities.OrderBooking", b =>
                {
                    b.HasOne("Alkonof_Backend.Domain.Entities.BookingType", "BookingType")
            ...
            modelBuilder.Entity("Alkonof_Backend.Domain.Entities.Permission", b =>
                {
                    b.HasOne("Alkonof_Backend.Domain.Entities.PermissionGrop", "PermissionGrop")
                        .WithMany("Permissions")
                        .HasForeignKey("PermissionGropId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PermissionGrop");
                });

            modelBuilder.Entity("Alkonof_Backend.Domain.Entities.PrepareMeeting", b =>
                {
                    b.HasOne("Alkonof_Backend.Domain.Entities.Booking", "Booking")
                        .WithMany("PrepareMeetings")
                        .HasForeignKey("BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Alkonof_Backend.Domain.Entities.Meeting", "Meeting")
                        .WithOne("PrepareMeeting")
                        .HasForeignKey("Alkonof_Backend.Domain.Entities.PrepareMeeting", "MeetingId");
